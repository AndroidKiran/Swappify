...
import swapp.items.com.swappify.components.paginate.Paginate;
...
public final class RecyclerPaginate extends Paginate {
    ...
    void checkEndOffset(int direction) {
...
//        checkEndOffset();
    ...
    private final RecyclerView.OnScrollListener mOnScrollListener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            if (dy > 0) {
                checkEndOffset(Paginate.SCROLL_UP); // Each time when list is scrolled check if end of the list is reached
            } else {
                checkEndOffset(Paginate.SCROLL_DOWN); // Each time when list is scrolled check if end of the list is reached
            }
        }
    };
