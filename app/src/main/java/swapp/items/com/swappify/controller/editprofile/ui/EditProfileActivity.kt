...
import swapp.items.com.swappify.controller.editprofile.model.Place
...
class EditProfileActivity : BaseActivity<ActivityEditProfileBinding, EditProfileViewModel>(), AppBarLayout.OnOffsetChangedListener, EasyPermissions.PermissionCallbacks {
    ...
    override fun executePendingVariablesBinding() {
        activityEditProfileBinding = getViewDataBinding().also {
            it.setVariable(BR.editProfileViewModel, editProfileViewModel)
            it.setVariable(BR.callBack, this@EditProfileActivity.callBack)
